...
function SwitchScene()
{
    ...
    currentContent = currentContent.concat(scene.LoadSceneXML(asset.GetAsset(SCENENAME).DiskSource(), false, false, 0));
...
//    cameraData.motion = me.placeable.Orientation().Mul(cameraData.motion);
    var CurPos = me.placeable.Position();
    CurPos.x = Clamp(CurPos.x, CAMERA_MIN_X, CAMERA_MAX_X);
    CurPos.z = Clamp(CurPos.z, CAMERA_MIN_Z, CAMERA_MAX_Z);
    me.placeable.SetPosition(CurPos.Add(cameraData.motion));
}
