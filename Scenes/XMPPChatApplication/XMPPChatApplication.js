...
function Client(username)
{
    ...
    this.xmppClient.ConnectToServer("chiru.cie.fi", "miika@chiru.cie.fi", "Chiru000");  
}

Client.prototype.JoinWebchat = function()
{
    this.muc.RoomAdded.connect(this, this.RoomJoined);
    this.muc.JoinRoom("webchat@conference.chiru.cie.fi", "Miika", "");
    this.muc.JoinRoom("random1@conference.chiru.cie.fi", "Miika", "");
    this.muc.JoinRoom("kolmas@conference.chiru.cie.fi", "Miika", "");
}
